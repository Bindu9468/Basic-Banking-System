...
<div id="lock"><img src="statics/logospark.png" alt="" style="width:50%; margin-top:50%;"><br>
...
<div id="container">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed fixed-top"
        ...
        <div class="container-fluid">
            <a href="index.php"><img src="statics\logospark.png" alt=""
        ...
        <div class="row">
            <div class="col" style="margin-left: 5%;">
                <br><br>&nbsp;<p class="zoomfont"
                    style="font-size:0px;color:#CD5C5C; text-shadow:3px 3px 3px grey; text-align:center;"><b> The <br> Sparks Foundation <br>  Bank </b></p>
            </div>
            <div class="col" style="margin:4% 0% 0% 5%; text-align:center;">
                &nbsp;<img src="statics/fi.jpg" class="zoomin" alt="" height="300px" width="300px" style="width:0px;">
            </div>
        </div>
    </div>
    ...
    <center style="margin:10px 0px 10px 0px;">
        <div class="container"
            ...
            <h1 style="text-shadow:2px 2px 2px gray; color: violet;"><b>Facilities we provide</b></h1>
                ...
                <div class="row">
                    <div class="col-lg">
                        <div
                            ...
                            <h6 style=" color: #BDB76B;"> View every customer of the bank.</h6>
                        </div>
                    </div>
                    <div class="col-lg">
                        <div
                            ...
                            <a href="send_money.php"><button type="button" class="btn btn-outline-light mybtn">Transfer
                                    Money</button></a><br>
                            <h6 style=" color:#BDB76B;">Transfer money from your account.</h6>
                        </div>
                    </div>
                    <div class="col-lg">
                        <div
                            ...
                            <a href="check_blc.php"><button type="button" class="btn btn-outline-light mybtn">Check
                                    Balance</button></a><br>
                            <h6 style=" color: #BDB76B;">Check the balance in your account.</h6>
                        </div>
                    </div>
                </div>
            </div>
