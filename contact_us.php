...
<body style="background-image:url('statics/contact.jpg'); padding-top:8%;">
...
?>
    ...
    <center>
        <div class="container" style="padding:10px 80px 10px 80px; margin-top:2%;">
            <div
                style="width:80%; background: linear-gradient(to bottom, #cc6699 0%, #0066ff 100%); padding:5px 5px 5px 5px; border-radius:30px; box-shadow: 2px 2px 10px gray;">
