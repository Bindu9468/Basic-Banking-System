...
<body style="background-color:#212529;">
    ...
    <center>
        <div class="container" style="margin-top: 9%; padding:10px 80px 10px 80px; ">
            <div
                style="width:50%; background: linear-gradient(to bottom, #cc6699 0%, #0066ff 100%); padding:5px 5px 5px 5px; border-radius:30px; box-shadow: 2px 2px 10px gray;">
                <h1 style=" color:black;">About Us</h1>
            </div>
           <br/> <br/>
           
            <p style="color:white; font-size: 18px;">This website is created by</p>
            <h1 style="color:Khaki; font-size: 60px; text-shadow:2px 2px 2px gray;">Bindu Priya R</h1>
            <p style="color:gray; font-size: 20px;"><b >Intern at Sparks Foundation <br> <b>Email</b>: <a href="mailto:bindu@gmail.com" style="text-decoration: none">bindu@gmail.com</a><br/>
                     <b>Phone-No:</b> <a href="tel:1234567893" style="text-decoration: none">1234567893</a></b></p>
    </center>
